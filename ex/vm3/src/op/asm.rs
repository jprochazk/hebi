...
_asm!(store_global,          src: Reg<u8>, name: Const<u16>);
_asm!(load_field,            dst: Reg<u8>, name: Const<u16>);
_asm!(load_field_opt,        dst: Reg<u8>, name: Const<u16>);
_asm!(store_field,           obj: Reg<u8>, name: Reg<u8>, src: Reg<u8>);
