...
instructions! {
  ...
  StoreField(object: Register, name: Constant),
  LoadIndex(object: Register),
  LoadIndexOpt(object: Register),
  StoreIndex(object: Register, key: Register),
  LoadSelf,
  LoadSuper,
  LoadNone,
  LoadTrue,
  ...
  // TODO: MakeConstList / MakeConstTable for statically known values
